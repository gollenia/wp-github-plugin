...
const { tagAndPush } = require('../index'); // oder wo du es exportierst
...
describe('tagAndPush', () => {
  ...
  it('setzt ein neues Tag und pusht es', () => {
    ...
    expect(child_process.execSync).toHaveBeenNthCalledWith(2, 'git tag v1.2.3', { stdio: 'inherit' });
    expect(child_process.execSync).toHaveBeenNthCalledWith(3, 'git push origin v1.2.3', { stdio: 'inherit' });
  });
